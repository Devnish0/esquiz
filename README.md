...
- **Web Audio API** — Generated sound effects (no audio files)
...
```
├── index.html      # Main HTML (4-screen SPA)
├── style.css       # Complete design system
├── app.js          # Quiz engine & UI logic
├── questions.js    # All 148 questions with answers
...
4. Your quiz will be live at `https://username.github.io/repo-name/`

---

## 👤 Created By

**Ashu Dhanda** — Made with ❤️
